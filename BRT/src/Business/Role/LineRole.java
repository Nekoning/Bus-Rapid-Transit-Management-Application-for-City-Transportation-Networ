...
import UserInterface.LineRole.LineWorkAreaJPanel;
...
public class LineRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, BRTSystem system) {
        return new LineWorkAreaJPanel(userProcessContainer, userAccount, (LineOrganization)organization, enterprise);
    }
